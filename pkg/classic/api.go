...
func (c *Client) AuctionHouseIndex(connectedRealmId int, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/connected-realm/%v/auctions/index", connectedRealmId)), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) Auctions(connectedRealmId int, auctionHouseId int, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/connected-realm/%v/auctions/%v", connectedRealmId, auctionHouseId)), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) PvPRegionIndex(namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/pvp-region/index", )), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) PvPRegionalSeasonIndex(pvpRegionId int, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/pvp-region/%v/pvp-season/index", pvpRegionId)), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) PvPRegionalSeason(pvpRegionId int, pvpSeasonId int, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/pvp-region/%v/pvp-season/%v", pvpRegionId, pvpSeasonId)), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) PvPLeaderboardsIndex(pvpRegionId int, pvpSeasonId int, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/pvp-region/%v/pvp-season/%v/pvp-leaderboard/index", pvpRegionId, pvpSeasonId)), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) PvPLeaderboard(pvpRegionId int, pvpSeasonId int, pvpBracket string, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/pvp-region/%v/pvp-season/%v/pvp-leaderboard/%v", pvpRegionId, pvpSeasonId, pvpBracket)), nil)
	if err != nil {
		return "", err
	}
...
//   namespace: The namespace to use to locate this document. (string) (required) (default: dynamic-classic-us)
//   locale: The locale to reflect in localized data. (string)  (default: en_US)
func (c *Client) PvPRewardsIndex(pvpRegionId int, pvpSeasonId int, namespace string, locale string) (string, error) {
	req, err := http.NewRequest("GET", filepath.Join(BlizzardAPIUrl, fmt.Sprintf("/data/wow/pvp-region/%v/pvp-season/%v/pvp-reward/index", pvpRegionId, pvpSeasonId)), nil)
	if err != nil {
		return "", err
	}
